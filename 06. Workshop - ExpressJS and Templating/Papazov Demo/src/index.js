...
// for setting handlebars as a view engine
app.engine('hbs', handlebars.engine({
    extname: 'hbs'
}));
app.set('view engine', 'hbs');
app.set('views', './src/views'); 
// when starting the app, the app by means of res.render('index',{OPTIONS}), searches the views in root/views 
// -> the root here being based on where index.js is
...
// HOW the rendering works ->
    ...
    // res.render -> handlebars expects a main.hbs in a layouts folder to begin with, it's the main skelelton
